...
define('Playground', __DIR__.'/vendor/filipsedivy/php-eet/src/Schema/PlaygroundService.wsdl');
define('Production', __DIR__.'/vendor/filipsedivy/php-eet/src/Schema/ProductionService.wsdl');
define('MediaCreator', __DIR__.'/vendor/filipsedivy/php-eet/src/Schema/MediaCreatorWS.wsdl');
